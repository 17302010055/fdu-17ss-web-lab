...
//        include("travel-data.inc.php");
        foreach ($images as $key=>$value){
            $img = '<li> <a href = "details.php?id=' . $images[$key]["id"] . '" class="img-responsive"> <img src="images/square/' . $images[$key]["path"] .
                '" alt="' . $images[$key]["title"] . '"/> <div class="caption"> <div class = "blur"></div> <div class="caption-text"><h1>' . $images[$key]["title"] . '</h1>' .
                '</div></div></a></li>';
            echo $img;
        }
        /* you will need to fill this place with appropriate PHP */
